...
#include <control_turtlebot/StartFindingPath.h>
...
class OfflinePlannerR2
{
    public:
		...
		OfflinePlannerR2();
		//! Planner setup
		void planWithSimpleSetup(std::vector<double> start_state, std::vector<double> goal_state, control_turtlebot::StartFindingPath::Response& response);
        ...
        bool startFindingPath(control_turtlebot::StartFindingPath::Request& request, control_turtlebot::StartFindingPath::Response& response);
    private:
		// *** ROS ***
...
OfflinePlannerR2::OfflinePlannerR2()
{
    ...
    service_ = node_handler_.advertiseService("/controller_turtlebot/start_finding_path", &OfflinePlannerR2::startFindingPath, this);
}
...
*/
void OfflinePlannerR2::planWithSimpleSetup(std::vector<double> start_state, std::vector<double> goal_state, control_turtlebot::StartFindingPath::Response& response)
{
	//=======================================================================
...
bool OfflinePlannerR2::startFindingPath(control_turtlebot::StartFindingPath::Request& request, control_turtlebot::StartFindingPath::Response& response)
{
	vector<double> goal_state;
	goal_state.resize(2);
    ROS_INFO("Finding path to my start location");
    myFile.open("/home/anirudh/catkin_ws/src/ar_project/pose.txt");
